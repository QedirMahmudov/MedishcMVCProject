        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZodocRating = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ReviewCount = table.Column<int>(type: "int", nullable: false),
                    SocialMediaFacebook = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocialMediaTwitter = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OpeningHours_Doctors_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceLists_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpeningHours_DoctorId",
                table: "OpeningHours",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_PriceLists_DoctorId",
                table: "PriceLists",
                column: "DoctorId");
        }
